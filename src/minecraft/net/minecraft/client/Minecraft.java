...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    private void runGameLoop() throws IOException
    {
        ...
        ++this.fpsCounter;
        this.isGamePaused = this.isSingleplayer() && this.currentScreen != null && this.currentScreen.doesGuiPauseGame() && !this.theIntegratedServer.getPublic() && !(this.currentScreen instanceof ClickGUI);
    ...
    private void rightClickMouse()
    {
        ...
        {
            this.rightClickDelayTimer = vClient.instance.moduleManager.getModulebyName("FastPlace").isToggled() ? (int) vClient.instance.settingsManager.getSettingByName("Block Delay").getValDouble() : 4;
